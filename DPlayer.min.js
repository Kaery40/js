!function(n, e) {
    ...
    var n = {
        916: (n, e, t) => {
            ...
            n.exports = function(n) {
                "use strict";
                var e, o = "", r = (n = n || {}).video, i = n.options, l = a.$escape, s = n.tran, p = n.icons, d = n.index, c = a.$each;
                return n.$value,
                n.$index,
                ...
                return {
                    update: function(t) {
                        !function(n, e, t) {
                            ...
                            o && (a += "@layer".concat(t.layer.length > 0 ? " ".concat(t.layer) : "", " {")),
                            a += t.css,
                            o && (a += "}"),
                            t.media && (a += "}"),
                            t.supports && (a += "}");
        ...
        897: (n, e, t) => {
            ...
            var a = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t.g ? t.g : {}
              ...
              , r = /["&'<>]/;
            function i(n) {
                return "string" != typeof n && (n = null == n ? "" : "function" == typeof n ? i(n.call(n)) : JSON.stringify(n)),
                n
            }
            o.$escape = function(n) {
                return function(n) {
            ...
            n.exports = function(n) {
                ...
                e.i = function(n, t, a, o, r) {
                    ...
                    for (var p = 0; p < n.length; p++) {
                        var d = [].concat(n[p]);
                        a && i[d[0]] || (void 0 !== r && (void 0 === d[5] || (d[1] = "@layer".concat(d[5].length > 0 ? " ".concat(d[5]) : "", " {").concat(d[1], "}")),
                        d[5] = r),
    ...
    t.d = (n, e) => {
        for (var a in e)
            t.o(e, a) && !t.o(n, a) && Object.defineProperty(n, a, {
                enumerable: !0,
                get: e[a]
            })
    }
    ...
    return ( () => {
        ...
        function w(n, e) {
            ...
            E._immediateFn((function() {
                ...
                if (null !== t) {
                    ...
                    (1 === n._state ? C : k)(e.promise, n._value)
            }
            ))) : n._deferreds.push(e)
        }
        function C(n, e) {
                ...
                for (var r = [], i = 0; i < o.length; i++)
                    try {
                        e.resolve(o[i]).then(t).catch((function(n) {
                            r.push(n),
                            r.length === o.length && a(new f(r,"All promises were rejected"))
                        }
                        ))
                    } catch (n) {
                        a(n)
        ...
        E.allSettled = function(n) {
            return new this((function(e, t) {
                if (!n || void 0 === n.length)
                    return t(new TypeError(h(n) + " " + n + " is not iterable(cannot read property Symbol(Symbol.iterator))"));
                var a = Array.prototype.slice.call(n);
                if (0 === a.length)
                    return e([]);
                var o = a.length;
                function r(n, t) {
                    if (t && ("object" === h(t) || "function" == typeof t)) {
                        ...
                        if ("function" == typeof i)
                            return void i.call(t, (function(e) {
                                r(n, e)
                            }
                            ), (function(t) {
                                a[n] = {
        ...
        const T = {
            secondToTime: function(n) {
                if (0 === (n = n || 0) || n === 1 / 0 || "NaN" === n.toString())
                    return "00:00";
            ...
            getBoundingClientRectViewLeft: function(n) {
                ...
                if (n.getBoundingClientRect) {
                    if ("number" != typeof this.getBoundingClientRectViewLeft.offset) {
                        ...
                        this.getBoundingClientRectViewLeft.offset = -t.getBoundingClientRect().top - e,
            ...
            setScrollPosition: function(n) {
                var e = n.left
                  ...
                  , a = n.top
                  , o = void 0 === a ? 0 : a;
                this.isFirefox ? (document.documentElement.scrollLeft = t,
                document.documentElement.scrollTop = o) : window.scrollTo(t, o)
            },
            isMobile: z,
        ...
        var j, D = Object.prototype.toString, P = Object.getPrototypeOf, R = (j = Object.create(null),
        function(n) {
            var e = D.call(n);
        ...
        }, F = Array.isArray, W = M("undefined"), U = Y("ArrayBuffer"), N = M("string"), Q = M("function"), H = M("number"), _ = function(n) {
        ...
        function $(n, e) {
            var t, a, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = o.allOwnKeys, i = void 0 !== r && r;
            if (null != n)
                if ("object" !== O(n) && (n = [n]),
                F(n))
                    for (t = 0,
                    ...
                    var l, s = i ? Object.getOwnPropertyNames(n) : Object.keys(n), p = s.length;
                    for (t = 0; t < p; t++)
                        l = s[t],
                        e.call(null, n[l], l, n)
                }
        ...
        function nn(n, e) {
            ...
            for (var t, a = Object.keys(n), o = a.length; o-- > 0; )
                if (e === (t = a[o]).toLowerCase())
                    return t;
            return null
        }
        var en, tn, an = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global, on = function(n) {
            return !W(n) && n !== an
        }, rn = (en = "undefined" != typeof Uint8Array && P(Uint8Array),
        function(n) {
            return en && n instanceof en
        }
        ), ln = Y("HTMLFormElement"), sn = (tn = Object.prototype.hasOwnProperty,
        function(n, e) {
            return tn.call(n, e)
        }
        ), pn = Y("RegExp"), dn = function(n, e) {
        ...
        const cn = {
            ...
            inherits: function(n, e, t, a) {
                n.prototype = Object.create(e.prototype, a),
            ...
            toFlatObject: function(n, e, t, a) {
                ...
                null == n)
                    return e;
                do {
                    for (r = (o = Object.getOwnPropertyNames(n)).length; r-- > 0; )
                        i = o[r],
                        a && !a(i, n, e) || l[i] || (e[i] = n[i],
                        l[i] = !0);
                    n = !1 !== t && P(n)
            ...
            forEachEntry: function(n, e) {
                for (var t, a = (n && n[Symbol.iterator]).call(n); (t = a.next()) && !t.done; ) {
                    var o = t.value;
                    e.call(n, o[0], o[1])
                }
            },
            matchAll: function(n, e) {
                for (var t, a = []; null !== (t = n.exec(e)); )
                    a.push(t);
                return a
            },
            isHTMLForm: ln,
            ...
            freezeMethods: function(n) {
                dn(n, (function(e, t) {
                    if (Q(n) && -1 !== ["arguments", "caller", "callee"].indexOf(t))
                        return !1;
                    var a = n[t];
                    Q(a) && (e.enumerable = !1,
            ...
            toObjectSet: function(n, e) {
                ...
                return F(n) ? a(n) : a(String(n).split(e)),
                t
            },
        ...
        const En = function(n, e, t) {
            ...
            ))).metaTokens, r = t.visitor || d, i = t.dots, l = t.indexes, s = (t.Blob || "undefined" != typeof Blob && Blob) && (a = e) && cn.isFunction(a.append) && "FormData" === a[Symbol.toStringTag] && a[Symbol.iterator];
            if (!cn.isFunction(r))
            ...
            function d(n, t, a) {
                ...
                if (n && !a && "object" === fn(n))
                    if (cn.endsWith(t, "{}"))
                    ...
                    }(n) || cn.isFileList(n) || cn.endsWith(t, "[]") && (r = cn.toArray(n)))
                        return t = gn(t),
                        ...
                        !1;
                return !!bn(n) || (e.append(vn(a, t, i), p(n)),
                !1)
            }
            var c = []
              , A = Object.assign(xn, {
        ...
        function In(n, e, t) {
            if (!e)
                return n;
            var a, o = t && t.encode || Sn, r = t && t.serialize;
          ...
          , Fn = function(n) {
            function e(n, t, a, o) {
                var r = n[o++]
                  , i = Number.isFinite(+r)
                  , l = o >= n.length;
                return r = !r && cn.isArray(a) ? a.length : r,
                l ? (cn.hasOwnProp(a, r) ? a[r] = [a[r], t] : a[r] = t,
                !i) : (a[r] && cn.isObject(a[r]) || (a[r] = []),
                e(n, t, a[r], o) && cn.isArray(a[r]) && (a[r] = function(n) {
                    var e, t, a = {}, o = Object.keys(n), r = o.length;
                    for (e = 0; e < r; e++)
                        a[t = o[e]] = n[t];
                    return a
                }(a[r])),
        ...
        var Wn = {
          ...
          , Un = {
            ...
            transformRequest: [function(n, e) {
                var t, a = e.getContentType() || "", o = a.indexOf("application/json") > -1, r = cn.isObject(n);
                if (r && cn.isHTMLForm(n) && (n = new FormData(n)),
                cn.isFormData(n))
                    return o && o ? JSON.stringify(Fn(n)) : n;
                if (cn.isArrayBuffer(n) || cn.isBuffer(n) || cn.isStream(n) || cn.isFile(n) || cn.isBlob(n))
                    return n;
                if (cn.isArrayBufferView(n))
                    return n.buffer;
                if (cn.isURLSearchParams(n))
                        ...
                        return function(n, e) {
                            return En(n, new Mn.classes.URLSearchParams, Object.assign({
                                visitor: function(n, e, t, a) {
                                    return Mn.isNode && cn.isBuffer(n) ? (this.append(e, n.toString("base64")),
                ...
                return r || o ? (e.setContentType("application/json", !1),
                function(n, e, t) {
                    if (cn.isString(n))
                        try {
                            return (0,
            ...
            transformResponse: [function(n) {
                ...
                if (n && cn.isString(n) && (t && !this.responseType || a)) {
                    ...
                    try {
                        ...
                        if (o) {
                            if ("SyntaxError" === n.name)
                                throw mn.from(n, mn.ERR_BAD_RESPONSE, this, null, this.response);
                            throw n
                        }
                    }
                }
        ...
        var Gn = function(n, e) {
            ...
            o = [{
                ...
                value: function(n, e, t) {
                    ...
                    return cn.isPlainObject(n) || n instanceof this.constructor ? d(n, e) : cn.isString(n) && (n = n.trim()) && !/^[-_a-zA-Z]+$/.test(n.trim()) ? d((p = {},
                    (r = n) && r.split("\n").forEach((function(n) {
                        s = n.indexOf(":"),
                        i = n.substring(0, s).trim().toLowerCase(),
                        l = n.substring(s + 1).trim(),
                        !i || p[i] && Qn[i] || ("set-cookie" === i ? p[i] ? p[i].push(l) : p[i] = [l] : p[i] = p[i] ? p[i] + ", " + l : l)
                    }
                    )),
                    p), e) : null != n && o(e, n, t),
                    this
                ...
                value: function(n, e) {
                    if (n = Vn(n)) {
                        ...
                        if (t) {
                            ...
                            if (!0 === e)
                                return function(n) {
                                    for (var e, t = Object.create(null), a = /([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g; e = a.exec(n); )
                                        t[e[1]] = e[2];
                                    return t
                                }(a);
                            if (cn.isFunction(e))
                ...
                value: function(n, e) {
                    ...
                    function o(n) {
                        if (n = Vn(n)) {
                            ...
                            !o || e && !Jn(0, t[o], o, e) || (delete t[o],
                            a = !0)
                        }
                    }
                    return cn.isArray(n) ? n.forEach(o) : o(n),
                    a
                }
            }, {
                key: "clear",
                ...
                value: function() {
                    return Object.entries(this.toJSON()).map((function(n) {
                        ...
                        function(n) {
                            ...
                            if (null != t) {
                                var a, o, r, i, l = [], s = !0, p = !1;
                                try {
                                    if (r = (t = t.call(n)).next,
                                    0 === e) {
                                        if (Object(t) !== t)
                                            return;
                                        s = !1
                                    } else
                                        for (; !(s = (a = r.call(t)).done) && (l.push(a.value),
                                        l.length !== e); s = !0)
                                            ;
                                } catch (n) {
                                    p = !0,
                            ...
                            if (n) {
                                ...
                                "Map" === t || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _n(n, e) : void 0
                            }
                        }(e, t) || function() {
            ...
            r = [{
                ...
                key: "concat",
                value: function(n) {
                    for (var e = new this(n), t = arguments.length, a = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++)
                        a[o - 1] = arguments[o];
                ...
                value: function(n) {
                    ...
                    return cn.isArray(n) ? n.forEach(a) : a(n),
                    this
                }
            }],
            o && Kn(a.prototype, o),
        ...
        function te(n, e, t) {
            mn.call(this, null == n ? "canceled" : n, mn.ERR_CANCELED, e, t),
        ...
        const ae = te
          , oe = Mn.isStandardBrowserEnv ? {
            write: function(n, e, t, a, o, r) {
                var i = [];
                i.push(n + "=" + encodeURIComponent(e)),
                cn.isNumber(t) && i.push("expires=" + new Date(t).toGMTString()),
                cn.isString(a) && i.push("path=" + a),
                cn.isString(o) && i.push("domain=" + o),
                !0 === r && i.push("secure"),
        ...
        function le(n, e) {
            var t = 0
              , a = function(n, e) {
                n = n || 10;
                var t, a = new Array(n), o = new Array(n), r = 0, i = 0;
            ...
            return function(o) {
                ...
                p[e ? "download" : "upload"] = !0,
                n(p)
            }
        }
        const se = "undefined" != typeof XMLHttpRequest && function(n) {
            return new Promise((function(e, t) {
                var a, o = n.data, r = $n.from(n.headers).normalize(), i = n.responseType;
                function l() {
                ...
                if (s.open(n.method.toUpperCase(), In(c, n.params, n.paramsSerializer), !0),
                s.timeout = n.timeout,
                ...
                ,
                s.onabort = function() {
                    s && (t(new mn("Request aborted",mn.ECONNABORTED,n,s)),
                    s = null)
                }
                ,
                s.onerror = function() {
                    t(new mn("Network Error",mn.ERR_NETWORK,n,s)),
                    s = null
                }
                ,
                s.ontimeout = function() {
                    ...
                    t(new mn(e,a.clarifyTimeoutError ? mn.ETIMEDOUT : mn.ECONNABORTED,n,s)),
                    s = null
                }
                ,
                ...
                "setRequestHeader"in s && cn.forEach(r.toJSON(), (function(n, e) {
                    s.setRequestHeader(e, n)
                }
                )),
                cn.isUndefined(n.withCredentials) || (s.withCredentials = !!n.withCredentials),
                i && "json" !== i && (s.responseType = n.responseType),
                "function" == typeof n.onDownloadProgress && s.addEventListener("progress", le(n.onDownloadProgress, !0)),
                "function" == typeof n.onUploadProgress && s.upload && s.upload.addEventListener("progress", le(n.onUploadProgress)),
                (n.cancelToken || n.signal) && (a = function(e) {
                    s && (t(!e || e.type ? new ae(null,n,s) : e),
                    s.abort(),
                    s = null)
                }
                ,
        ...
        function ce(n) {
            ...
            n.data = ne.call(n, n.transformRequest),
            -1 !== ["post", "put", "patch"].indexOf(n.method) && n.headers.setContentType("application/x-www-form-urlencoded", !1),
            function(n) {
                for (var e, t, a = (n = cn.isArray(n) ? n : [n]).length, o = 0; o < a && (e = n[o],
                !(t = cn.isString(e) ? pe[e.toLowerCase()] : e)); o++)
                    ;
                if (!t) {
                    if (!1 === t)
                        throw new mn("Adapter ".concat(e, " is not supported by the environment"),"ERR_NOT_SUPPORT");
                ...
                return de(n),
                e.data = ne.call(n, n.transformResponse, e),
                e.headers = $n.from(e.headers),
                e
            }
            ), (function(e) {
                return ee(e) || (de(n),
                e && e.response && (e.response.data = ne.call(n, n.transformResponse, e.response),
        ...
        me.transitional = function(n, e, t) {
            ...
            return function(t, o, r) {
                if (!1 === n)
                    throw new mn(a(o, " has been removed" + (e ? " in " + e : "")),mn.ERR_DEPRECATED);
                return e && !he[o] && (he[o] = !0,
                ...
                for (var a = Object.keys(n), o = a.length; o-- > 0; ) {
                    ...
                    if (i) {
                        var l = n[r]
                          , s = void 0 === l || i(l, r, n);
                        if (!0 !== s)
                            throw new mn("option " + r + " must be " + s,mn.ERR_BAD_OPTION_VALUE)
                    } else if (!0 !== t)
                        throw new mn("Unknown option " + r,mn.ERR_BAD_OPTION)
                }
            },
            validators: me
        };
          ...
          , xe = function() {
            ...
            (t = [{
                ...
                value: function(n, e) {
                    ...
                    var t, a = e = ue(this.defaults, e), o = a.transitional, r = a.paramsSerializer, i = a.headers;
                    ...
                    void 0 !== r && fe.assertOptions(r, {
                        encode: ve.function,
                        serialize: ve.function
                    }, !0),
                    e.method = (e.method || this.defaults.method || "get").toLowerCase(),
                    (t = i && cn.merge(i.common, i[e.method])) && cn.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(n) {
                        delete i[n]
                    }
                    )),
                    ...
                    if (!s) {
                        ...
                        for (u.unshift.apply(u, l),
                        u.push.apply(u, d),
                        c = u.length,
                        p = Promise.resolve(e); A < c; )
                            p = p.then(u[A++], u[A++]);
                        return p
                    }
                    c = l.length;
        ...
        var ke = function() {
            function n(e) {
                ...
                this.promise.then((function(n) {
                    if (a._listeners) {
                        for (var e = a._listeners.length; e-- > 0; )
                            a._listeners[e](n);
                        a._listeners = null
                    }
                }
                ...
                ,
                e((function(n, e, o) {
                    a.reason || (a.reason = new ae(n,e,o),
                    t(a.reason))
                }
                ))
            }
        ...
        Object.entries(Ie).forEach((function(n) {
            ...
            function(n) {
                ...
                if (n) {
                    ...
                    var t = Object.prototype.toString.call(n).slice(8, -1);
                    return "Object" === t && n.constructor && (t = n.constructor.name),
                    "Map" === t || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? Se(n, e) : void 0
                }
            }(e, t) || function() {
                throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
            }()), o = a[0], r = a[1];
        ...
        ze.mergeConfig = ue,
        ze.AxiosHeaders = $n,
        ze.formToJSON = function(n) {
            return Fn(cn.isHTMLForm(n) ? new FormData(n) : n)
        }
        ,
        ze.HttpStatusCode = Le,
        ze.default = ze;
        const Te = ze
          , qe = {
            send: function(n) {
        ...
        function je(n) {
            ...
            this.tran = function(n) {
                return n = n.toLowerCase(),
                Pe[e.lang] && Pe[e.lang][n] ? Pe[e.lang][n] : Pe[e.fallbackLang] && Pe[e.fallbackLang][n] ? Pe[e.fallbackLang][n] : De[n] ? De[n] : n
            }
        }
        var De = {
        ...
        var Ct = function() {
            ...
            a = [{
                ...
                value: function(n, e, t) {
                    ...
                    return a.classList.add("dplayer-notice"),
                    a.style.opacity = e,
                    a.innerText = n,
                    t && (a.id = "dplayer-notice-".concat(t)),
                    a
                }
            }],
            (t = [{
        ...
        var It = function() {
            ...
            t = [{
                ...
                value: function() {
                    ...
                    t.push(n),
                    this.events && this.events.trigger("danmaku_load_start", t),
                    this._readAllEndpoints(t, (function(n) {
                ...
                value: function(n, e) {
                    for (var t = this, a = [], o = 0, r = function(r) {
                        t.options.apiBackend.read({
                            ...
                            error: function(i) {
                                t.options.error(i || t.options.tran("danmaku-failed")),
                                a[r] = [],
                                ++o === n.length && e(a)
                            }
                        })
                ...
                value: function(n, e) {
                    ...
                    this.dan.splice(this.danIndex, 0, a),
                    this.danIndex++;
                    var o = {
                    ...
                    this.draw(o),
                    this.events && this.events.trigger("danmaku_send", a)
                }
            }, {
                key: "frame",
                value: function() {
                    ...
                    if (this.dan.length && !this.paused && this.showing) {
                        for (var e = this.dan[this.danIndex], t = []; e && this.options.time() > parseFloat(e.time); )
                            t.push(e),
                            e = this.dan[++this.danIndex];
                        this.draw(t)
                    }
                    window.requestAnimationFrame((function() {
                        n.frame()
                ...
                value: function(n) {
                    if (void 0 !== n) {
                        for (var e = this.container.getElementsByClassName("dplayer-danmaku-item"), t = 0; t < e.length; t++)
                            e[t].style.opacity = n;
                        this._opacity = n,
                ...
                value: function(n) {
                    ...
                    if (this.showing) {
                          ...
                          , s = function(n, t, o) {
                            for (var s = a / l(o), p = function(o) {
                                ...
                                for (var d = 0; d < p.length; d++) {
                                    var c = i(p[d]) - 10;
                                    if (c <= a - s * l(parseInt(p[d].style.width)) || c <= 0)
                                        break;
                                    if (d === p.length - 1)
                                        return e.danTunnel[t][o + ""].push(n),
                                        n.addEventListener("animationend", (function() {
                                            e.danTunnel[t][o + ""].splice(0, 1)
                                        }
                                        )),
                        ...
                        for (var p = document.createDocumentFragment(), d = function() {
                            n[c].type = T.number2Type(n[c].type),
                            n[c].color || (n[c].color = 16777215);
                            var o = document.createElement("div");
                            o.classList.add("dplayer-danmaku-item"),
                            o.classList.add("dplayer-danmaku-".concat(n[c].type)),
                            n[c].border ? o.innerHTML = '<span style="border:'.concat(n[c].border, '">').concat(n[c].text, "</span>") : o.innerHTML = n[c].text,
                            o.style.opacity = e._opacity,
                            o.style.color = T.number2Color(n[c].color),
                            ...
                            switch (n[c].type) {
                            case "right":
                                (r = s(o, n[c].type, i)) >= 0 && (o.style.width = i + 1 + "px",
                                o.style.top = t * r + "px",
                                o.style.transform = "translateX(-".concat(a, "px)"));
                                break;
                            case "top":
                            ...
                            o.style.animationDuration = e._danAnimation(n[c].type),
                            p.appendChild(o))
                        }, c = 0; c < n.length; c++)
                            d();
                ...
                value: function(n) {
                    if (!this.context) {
                        ...
                        this.context.font = e.getPropertyValue("font")
                    }
                ...
                key: "resize",
                value: function() {
                    for (var n = this.container.offsetWidth, e = this.container.getElementsByClassName("dplayer-danmaku-item"), t = 0; t < e.length; t++)
                        e[t].style.transform = "translateX(-".concat(n, "px)")
                }
            }, {
                key: "hide",
                value: function() {
        ...
        const qt = function() {
            ...
            (t = [{
                key: "on",
                value: function(n, e) {
                    this.type(n) && "function" == typeof e && (this.events[n] || (this.events[n] = []),
                    this.events[n].push(e))
                }
            }, {
                key: "trigger",
                value: function(n, e) {
                    if (this.events[n] && this.events[n].length)
                        for (var t = 0; t < this.events[n].length; t++)
                            this.events[n][t](e)
                }
            }, {
                key: "type",
                value: function(n) {
                    return -1 !== this.playerEvents.indexOf(n) ? "player" : -1 !== this.videoEvents.indexOf(n) ? "video" : (console.error("Unknown event name: ".concat(n)),
                    null)
                }
            }]) && Tt(e.prototype, t),
            Object.defineProperty(e, "prototype", {
        ...
        var Dt = function() {
            function n(e) {
                ...
                this.player.events.on("webfullscreen_cancel", (function() {
                    t.player.resize(),
                    T.setScrollPosition(t.lastScrollPosition)
                }
                )),
                this.fullscreenchange = function() {
                    t.player.resize(),
                    t.isFullScreen("browser") ? t.player.events.trigger("fullscreen") : (T.setScrollPosition(t.lastScrollPosition),
                    t.player.events.trigger("fullscreen_cancel"))
                }
                ,
                this.docfullscreenchange = function() {
                    ...
                    n && n !== t.player.container || (t.player.resize(),
                    n ? t.player.events.trigger("fullscreen") : (T.setScrollPosition(t.lastScrollPosition),
                    t.player.events.trigger("fullscreen_cancel")))
                }
                ,
                /Firefox/.test(navigator.userAgent) ? (document.addEventListener("mozfullscreenchange", this.docfullscreenchange),
                document.addEventListener("fullscreenchange", this.docfullscreenchange)) : (this.player.container.addEventListener("fullscreenchange", this.fullscreenchange),
            ...
            t = [{
                ...
                value: function() {
                    ...
                    switch (t || (this.lastScrollPosition = T.getScrollPosition()),
                    n) {
                    case "browser":
                ...
                key: "destroy",
                value: function() {
                    /Firefox/.test(navigator.userAgent) ? (document.removeEventListener("mozfullscreenchange", this.docfullscreenchange),
                    document.removeEventListener("fullscreenchange", this.docfullscreenchange)) : (this.player.container.removeEventListener("fullscreenchange", this.fullscreenchange),
        ...
        var Mt = function() {
            ...
            (t = [{
                ...
                value: function(n, e) {
                    this.data[n] = e,
                    T.storage.set(this.storageName[n], e)
                }
            }]) && Yt(e.prototype, t),
            Object.defineProperty(e, "prototype", {
                writable: !1
        ...
        var Kt = function() {
            function n(e) {
                ...
                for (var a = this.player.template.subtitlesItem.length - 1, o = function(n) {
                    t.player.template.subtitlesItem[n].addEventListener("click", (function() {
                        t.hide(),
                        t.player.options.subtitle.index !== n && (t.player.template.subtitle.innerHTML = "<p></p>",
                        t.player.template.subtrack.src = t.player.template.subtitlesItem[n].dataset.subtitle,
                        t.player.options.subtitle.index = n,
                        t.player.template.subtitle.classList.contains("dplayer-subtitle-hide") && t.subContainerShow())
                    }
                    ))
                }, r = 0; r < a; r++)
                    o(r);
                this.player.template.subtitlesItem[a].addEventListener("click", (function() {
                    t.hide(),
                    t.player.options.subtitle.index !== a && (t.player.template.subtitle.innerHTML = "<p></p>",
                    t.player.template.subtrack.src = "",
                    t.player.options.subtitle.index = a,
                    t.subContainerHide())
                }
                ))
            }
            ...
            (t = [{
                ...
                value: function() {
                    ...
                    n >= e - 50 ? (this.player.template.subtitlesBox.style.bottom = "8px",
                    this.player.template.subtitlesBox.style["max-height"] = e - 8 + "px") : (this.player.template.subtitlesBox.style.bottom = "50px",
                    this.player.template.subtitlesBox.style["max-height"] = e - 50 + "px")
                }
            }]) && _t(e.prototype, t),
            Object.defineProperty(e, "prototype", {
                writable: !1
        ...
        var Jt = function() {
            function n(e) {
                ...
                this.elements = {},
                this.elements.volume = e.volumeBar,
                this.elements.played = e.playedBar,
                this.elements.loaded = e.loadedBar,
                this.elements.danmaku = e.danmakuOpacityBar
            }
            var e, t;
            return e = n,
            (t = [{
        ...
        var ea = function() {
            function n(e) {
                ...
                this.player = e,
                window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(n) {
            ...
            (t = [{
                ...
                value: function() {
                    ...
                    this.types.map((function(e) {
                        return "fps" !== e && n["init".concat(e, "Checker")](),
                        e
                    }
                    ))
                }
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval((function() {
                        n.enableloadingChecker && (t = n.player.video.currentTime,
                        a || t !== e || n.player.video.paused || (n.player.container.classList.add("dplayer-loading"),
                        a = !0),
                        a && t > e && !n.player.video.paused && (n.player.container.classList.remove("dplayer-loading"),
                        a = !1),
                        e = t)
                    }
                    ), 100)
                    ...
                    window.requestAnimationFrame((function() {
                        if (n.enablefpsChecker)
                            ...
                            n.fpsStart) {
                                n.fpsIndex++;
                                var e = new Date;
                                e - n.fpsStart > 1e3 && (n.player.infoPanel.fps(n.fpsIndex / (e - n.fpsStart) * 1e3),
                                n.fpsStart = new Date,
                                n.fpsIndex = 0)
                            } else
                                n.fpsStart = new Date,
                ...
                key: "enable",
                value: function(n) {
                    this["enable".concat(n, "Checker")] = !0,
                    "fps" === n && this.initfpsChecker()
                }
            }, {
                key: "disable",
                value: function(n) {
                ...
                value: function() {
                    var n = this;
                    this.types.map((function(e) {
                        return n["enable".concat(e, "Checker")] = !1,
                        n["".concat(e, "Checker")] && clearInterval(n["".concat(e, "Checker")]),
                        e
                    }
                    ))
                }
        ...
        var sa = function() {
            function n(e) {
                ...
                this.container = e.container,
                this.barWidth = e.barWidth,
                this.container.style.backgroundImage = "url('".concat(e.url, "')"),
            ...
            (t = [{
                key: "resize",
                value: function(n, e, t) {
                    this.container.style.width = "".concat(n, "px"),
                    this.container.style.height = "".concat(e, "px"),
                    this.container.style.top = "".concat(2 - e, "px"),
                    this.barWidth = t
                }
            }, {
                key: "show",
                ...
                key: "move",
                value: function(n) {
                    this.container.style.backgroundPosition = "-".concat(160 * (Math.ceil(n / this.barWidth * 100) - 1), "px 0"),
                    this.container.style.left = "".concat(Math.min(Math.max(n - this.container.offsetWidth / 2, -10), this.barWidth - 150), "px")
                }
            }, {
                key: "hide",
                value: function() {
        ...
        function ca(n, e) {
            for (var t = 0; t < e.length; t++) {
                ...
                "symbol" === da(o) ? o : String(o)), a)
            }
            var o
        }
        var Aa, ua = !0, ya = !1, ma = function() {
            function n(e) {
                !function(n, e) {
                    if (!(n instanceof e))
                        throw new TypeError("Cannot call a class as a function")
                ...
                T.isMobile || (this.setAutoHideHandler = this.setAutoHide.bind(this),
                ...
                this.player.options.subtitle && "string" == typeof this.player.options.subtitle.url && this.initSubtitleButton(),
                this.initHighlights(),
                this.initAirplayButton(),
                this.initChromecastButton(),
                T.isMobile || this.initVolumeButton()
            }
            var e, t;
            return e = n,
            (t = [{
                        ...
                        if (1 !== n.player.video.duration && n.player.video.duration !== 1 / 0 && n.player.options.highlight) {
                            ...
                            for (var t = 0; t < n.player.options.highlight.length; t++)
                                if (n.player.options.highlight[t].text && n.player.options.highlight[t].time) {
                                    var a = document.createElement("div");
                                    a.classList.add("dplayer-highlight"),
                                    a.style.left = n.player.options.highlight[t].time / n.player.video.duration * 100 + "%",
                                    a.innerHTML = '<span class="dplayer-highlight-text">' + n.player.options.highlight[t].text + "</span>",
                                    n.player.template.playedBarWrap.insertBefore(a, n.player.template.playedBarTime)
                                }
                        }
                    }
                    ))
                ...
                value: function() {
                    var n = this
                      , e = function(e) {
                        ...
                        t = Math.max(t, 0),
                        t = Math.min(t, 1),
                        n.player.bar.set("played", t, "width"),
                        n.player.template.ptime.innerHTML = T.secondToTime(t * n.player.video.duration)
                    }
                      , t = function t(a) {
                        document.removeEventListener(T.nameMap.dragEnd, t),
                        document.removeEventListener(T.nameMap.dragMove, e);
                        ...
                        o = Math.max(o, 0),
                        o = Math.min(o, 1),
                        n.player.bar.set("played", o, "width"),
                        n.player.seek(n.player.bar.get("played") * n.player.video.duration),
                        n.player.timer.enable("progress")
                    };
                    this.player.template.playedBarWrap.addEventListener(T.nameMap.dragStart, (function() {
                        n.player.timer.disable("progress"),
                        document.addEventListener(T.nameMap.dragMove, e),
                        document.addEventListener(T.nameMap.dragEnd, t)
                    }
                    )),
                    this.player.template.playedBarWrap.addEventListener(T.nameMap.dragMove, (function(e) {
                        if (n.player.video.duration) {
                            ...
                            if (a < 0 || a > n.player.template.playedBarWrap.offsetWidth)
                                return;
                            var o = n.player.video.duration * (a / n.player.template.playedBarWrap.offsetWidth);
                            T.isMobile && n.thumbnails && n.thumbnails.show(),
                            n.thumbnails && n.thumbnails.move(a),
                            n.player.template.playedBarTime.style.left = "".concat(a - (o >= 3600 ? 25 : 20), "px"),
                            n.player.template.playedBarTime.innerText = T.secondToTime(o),
                            n.player.template.playedBarTime.classList.remove("hidden")
                        }
                    }
                    )),
                    ...
                    T.isMobile || (this.player.template.playedBarWrap.addEventListener("mouseenter", (function() {
                        n.player.video.duration && (n.thumbnails && n.thumbnails.show(),
                        n.player.template.playedBarTime.classList.remove("hidden"))
                    }
                    )),
                    this.player.template.playedBarWrap.addEventListener("mouseleave", (function() {
                        n.player.video.duration && (n.thumbnails && n.thumbnails.hide(),
                        n.player.template.playedBarTime.classList.add("hidden"))
                    }
                    )))
                }
            }, {
                ...
                value: function() {
                    var n = this
                      ...
                      , t = function t() {
                        document.removeEventListener(T.nameMap.dragEnd, t),
                        document.removeEventListener(T.nameMap.dragMove, e),
                        n.player.template.volumeButton.classList.remove("dplayer-volume-active")
                    };
                    ...
                    this.player.template.volumeBarWrapWrap.addEventListener(T.nameMap.dragStart, (function() {
                        document.addEventListener(T.nameMap.dragMove, e),
                        document.addEventListener(T.nameMap.dragEnd, t),
                        n.player.template.volumeButton.classList.add("dplayer-volume-active")
                    }
                    )),
                    this.player.template.volumeButtonIcon.addEventListener("click", (function() {
                        n.player.video.muted ? (n.player.video.muted = !1,
                        n.player.switchVolumeIcon(),
                        n.player.bar.set("volume", n.player.volume(), "width")) : (n.player.video.muted = !0,
                        n.player.template.volumeIcon.innerHTML = gt.volumeOff,
                        n.player.bar.set("volume", 0, "width"))
                    }
                    ))
                }
            }, {
                ...
                value: function() {
                    ...
                    this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", (function() {
                        ...
                        t.width = n.player.video.videoWidth,
                        t.height = n.player.video.videoHeight,
                        t.getContext("2d").drawImage(n.player.video, 0, 0, t.width, t.height),
                        t.toBlob((function(t) {
                            ...
                            n.player.events.trigger("screenshot", e)
                        }
                        ))
                    }
                    ))
                ...
                value: function() {
                    this.player.options.airplay && (window.WebKitPlaybackTargetAvailabilityEvent ? this.player.video.addEventListener("webkitplaybacktargetavailabilitychanged", function(n) {
                        "available" === n.availability ? this.template.airplayButton.disable = !1 : this.template.airplayButton.disable = !0,
                ...
                value: function() {
                    ...
                    n.setAttribute("src", "https://www.gstatic.com/cv/js/sender/v1/cast_sender.js?loadCastFramework=1"),
                ...
                value: function() {
                    ...
                    if (this.player.options.chromecast) {
                        ...
                        this.player.template.chromecastButton.addEventListener("click", (function() {
                            ...
                            n.currentMedia.stop(),
                            n.session.stop(),
                            n.initChromecast()) : (ya = !0,
                            Aa.requestSession((function(a) {
                                var o, r, i;
                                n.session = a,
                                o = n.player.options.video.url,
                                r = new Aa.media.MediaInfo(o),
                                i = new Aa.media.LoadRequest(r),
                                n.session ? n.session.loadMedia(i, e.bind(n, "loadMedia"), t).play() : window.open(o)
                            }
                            ), (function(e) {
                ...
                value: function() {
                    ...
                    this.player.events.on("subtitle_show", (function() {
                        n.player.template.subtitleButton.dataset.balloon = n.player.tran("hide-subs"),
                        n.player.template.subtitleButtonInner.style.opacity = "",
                        n.player.user.set("subtitle", 1)
                    }
                    )),
                    this.player.events.on("subtitle_hide", (function() {
                        n.player.template.subtitleButton.dataset.balloon = n.player.tran("show-subs"),
                        n.player.template.subtitleButtonInner.style.opacity = "0.4",
                        n.player.user.set("subtitle", 0)
                    }
                    )),
                ...
                key: "destroy",
                value: function() {
                    T.isMobile || (this.player.container.removeEventListener("mousemove", this.setAutoHideHandler),
        ...
        var ga = function() {
            function n(e) {
                ...
                this.player.template.loop.addEventListener("click", (function() {
                    t.player.template.loopToggle.checked = !t.player.template.loopToggle.checked,
                    t.player.template.loopToggle.checked ? t.loop = !0 : t.loop = !1,
                    t.hide()
                }
                )),
                ...
                this.player.template.showDanmaku.addEventListener("click", (function() {
                    t.player.template.showDanmakuToggle.checked = !t.player.template.showDanmakuToggle.checked,
                    t.player.template.showDanmakuToggle.checked ? (t.showDanmaku = !0,
                    t.player.danmaku.show()) : (t.showDanmaku = !1,
                    t.player.danmaku.hide()),
                    t.player.user.set("danmaku", t.showDanmaku ? 1 : 0),
                    t.hide()
                }
                )),
                ...
                this.player.template.unlimitDanmaku.addEventListener("click", (function() {
                    t.player.template.unlimitDanmakuToggle.checked = !t.player.template.unlimitDanmakuToggle.checked,
                    t.player.template.unlimitDanmakuToggle.checked ? (t.unlimitDanmaku = !0,
                    t.player.danmaku.unlimit(!0)) : (t.unlimitDanmaku = !1,
                    t.player.danmaku.unlimit(!1)),
                    t.player.user.set("unlimited", t.unlimitDanmaku ? 1 : 0),
                    t.hide()
                }
                )),
                this.player.template.speed.addEventListener("click", (function() {
                    t.player.template.settingBox.classList.add("dplayer-setting-box-narrow"),
                    t.player.template.settingBox.classList.add("dplayer-setting-box-speed")
                }
                ));
                for (var a = function(n) {
                    t.player.template.speedItem[n].addEventListener("click", (function() {
                        t.player.speed(t.player.template.speedItem[n].dataset.speed),
                        t.hide()
                    }
                    ))
                ...
                if (this.player.danmaku) {
                    this.player.on("danmaku_opacity", (function(n) {
                        t.player.bar.set("danmaku", n, "width"),
                        t.player.user.set("opacity", n)
                    }
                    )),
                    ...
                    var r = function(n) {
                        ...
                        a = Math.max(a, 0),
                        a = Math.min(a, 1),
                        t.player.danmaku.opacity(a)
                    }
                      , i = function n() {
                        document.removeEventListener(T.nameMap.dragEnd, n),
                        document.removeEventListener(T.nameMap.dragMove, r),
                        t.player.template.danmakuOpacityBox.classList.remove("dplayer-setting-danmaku-active")
                    };
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(T.nameMap.dragStart, (function() {
                        document.addEventListener(T.nameMap.dragMove, r),
                        document.addEventListener(T.nameMap.dragEnd, i),
                        t.player.template.danmakuOpacityBox.classList.add("dplayer-setting-danmaku-active")
                    }
                    ))
                }
            }
            ...
            (t = [{
                ...
                value: function() {
                    ...
                    this.player.template.mask.classList.remove("dplayer-mask-show"),
                    setTimeout((function() {
                        n.player.template.settingBox.classList.remove("dplayer-setting-box-narrow"),
                        n.player.template.settingBox.classList.remove("dplayer-setting-box-speed")
                    }
                    ), 300),
                    this.player.controller.disableAutoHide = !1
                }
            ...
            function n(e) {
                ...
                this.player.template.commentColorSettingBox.addEventListener("click", (function() {
                    if (t.player.template.commentColorSettingBox.querySelector("input:checked+span")) {
                        ...
                        t.player.template.commentSettingFill.style.fill = n,
                        t.player.template.commentInput.style.color = n,
                        t.player.template.commentSendFill.style.fill = n
                    }
                }
                )),
            ...
            (t = [{
                ...
                value: function() {
                    ...
                    this.player.template.commentInput.value.replace(/^\s+|\s+$/g, "") ? this.player.danmaku.send({
                        ...
                        n.player.template.commentInput.value = "",
                        n.hide()
                    }
        ...
        var Sa = function() {
            function n(e) {
                ...
                this.player.options.hotkey && document.addEventListener("keydown", this.doHotKeyHandler),
            ...
            (t = [{
                ...
                key: "destroy",
                value: function() {
                    this.player.options.hotkey && document.removeEventListener("keydown", this.doHotKeyHandler),
        ...
        var Ta = function() {
            function n(e) {
                ...
                this.player = e,
                this.shown = !1,
                Array.prototype.slice.call(this.player.template.menuItem).forEach((function(n, e) {
                    t.player.options.contextmenu[e].click && n.addEventListener("click", (function() {
                        t.player.options.contextmenu[e].click(t.player),
                        t.hide()
                    }
                    ))
                }
                ...
                this.contextmenuHandler = function(n) {
                    if (t.shown)
                        ...
                        t.show(e.clientX - a.left, e.clientY - a.top),
                        t.player.template.mask.addEventListener("click", (function() {
                            t.hide()
                        }
                        ))
                    }
            ...
            (t = [{
                ...
                value: function(n, e) {
                    ...
                    n + this.player.template.menu.offsetWidth >= t.width ? (this.player.template.menu.style.right = t.width - n + "px",
                    this.player.template.menu.style.left = "initial") : (this.player.template.menu.style.left = n + "px",
                    this.player.template.menu.style.right = "initial"),
                    e + this.player.template.menu.offsetHeight >= t.height ? (this.player.template.menu.style.bottom = t.height - e + "px",
                    this.player.template.menu.style.top = "initial") : (this.player.template.menu.style.top = e + "px",
        ...
        var Da = function() {
            function n(e) {
                ...
                this.container = e.template.infoPanel,
            ...
            (t = [{
                ...
                key: "update",
                value: function() {
                    this.template.infoVersion.innerHTML = "v".concat("1.27.1", " ").concat("v1.27.0-12-g4f61091"),
        ...
        function Ua(n, e) {
            for (var t = 0; t < e.length; t++) {
                ...
                a.configurable = !0,
                "value"in a && (a.writable = !0),
                Object.defineProperty(n, Na(a.key), a)
            }
        }
        function Na(n) {
            var e = function(n, e) {
                if ("object" !== Ma(n) || null === n)
                    return n;
                var t = n[Symbol.toPrimitive];
                if (void 0 !== t) {
                    var a = t.call(n, "string");
          ...
          , _a = function() {
            function n(e) {
                ...
                this.options = function(n) {
                    ...
                    return n.video && !n.video.type && (n.video.type = "auto"),
                    "object" === Oe(n.danmaku) && n.danmaku && !n.danmaku.user && (n.danmaku.user = "DIYgod"),
                    n.subtitle && (!n.subtitle.type && (n.subtitle.type = "webvtt"),
                    !n.subtitle.fontSize && (n.subtitle.fontSize = "20px"),
                    !n.subtitle.bottom && (n.subtitle.bottom = "40px"),
                    !n.subtitle.color && (n.subtitle.color = "#fff")),
                    n.video.quality && (n.video.url = n.video.quality[n.video.defaultQuality].url),
                    n.lang && (n.lang = n.lang.toLowerCase()),
                    n.contextmenu = n.contextmenu.concat([{
                        key: "video-info",
                        click: function(n) {
                            n.infoPanel.triggle()
                        }
                ...
                this.tran = new je(this.options.lang).tran,
                this.events = new qt,
                this.user = new Ft(this),
                this.container = this.options.container,
                this.noticeList = {},
                ...
                T.isMobile && this.container.classList.add("dplayer-mobile"),
                this.arrow = this.container.offsetWidth <= 500,
                this.arrow && this.container.classList.add("dplayer-arrow"),
                this.options.subtitle && Array.isArray(this.options.subtitle.url) && (this.options.subtitle.url.push({
                    subtitle: "",
                    lang: "off"
                }),
                ...
                )) : "number" == typeof this.options.subtitle.defaultSubtitle && (this.options.subtitle.index = this.options.subtitle.defaultSubtitle)),
                (-1 === this.options.subtitle.index || !this.options.subtitle.index || this.options.subtitle.index > this.options.subtitle.url.length - 1) && (this.options.subtitle.index = this.options.subtitle.url.findIndex((function(n) {
                    return n.lang === t.options.lang
                }
                ))),
                -1 === this.options.subtitle.index && (this.options.subtitle.index = this.options.subtitle.url.length - 1)),
                this.template = new kt({
                ...
                this.bar = new Gt(this.template),
                this.bezel = new ra(this.template.bezel),
                this.fullScreen = new Pt(this),
                this.controller = new ha(this),
                this.options.danmaku && (this.danmaku = new Lt({
                    player: this,
                    container: this.template.danmaku,
                    opacity: this.user.get("opacity"),
                    callback: function() {
                        setTimeout((function() {
                            t.template.danmakuLoading.style.display = "none",
                ...
                this.comment = new Ca(this)),
                this.setting = new va(this),
                this.plugins = {},
                ...
                ,
                document.addEventListener("click", this.docClickFun, !0),
                this.container.addEventListener("click", this.containerClickFun, !0),
                this.paused = !0,
                this.timer = new ta(this),
                this.hotkey = new Ia(this),
                this.contextmenu = new qa(this),
                this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type),
                this.infoPanel = new Pa(this),
            ...
            t = [{
                ...
                value: function(n) {
                    n = Math.max(n, 0),
                    this.video.duration && (n = Math.min(n, this.video.duration)),
                    this.video.currentTime < n ? this.notice("".concat(this.tran("ff").replace("%s", (n - this.video.currentTime).toFixed(0)))) : this.video.currentTime > n && this.notice("".concat(this.tran("rew").replace("%s", (this.video.currentTime - n).toFixed(0)))),
                    this.video.currentTime = n,
                    this.danmaku && this.danmaku.seek(),
                    this.bar.set("played", n / this.video.duration, "width"),
                    this.template.ptime.innerHTML = T.secondToTime(n)
                }
            }, {
                key: "play",
                value: function(n) {
                    var e = this;
                    if (this.paused = !1,
                    this.video.paused && !T.isMobile && this.bezel.switch(gt.play),
                    this.template.playButton.innerHTML = gt.pause,
                    this.template.mobilePlayButton.innerHTML = gt.pause,
                    n || L.resolve(this.video.play()).catch((function() {
                        e.pause()
                    }
                    )).then((function() {}
                    )),
                ...
                value: function(n) {
                    ...
                    this.video.paused || T.isMobile || this.bezel.switch(gt.pause),
                    this.template.playButton.innerHTML = gt.play,
                    this.template.mobilePlayButton.innerHTML = gt.play,
                    n || this.video.pause(),
                ...
                value: function(n, e, t) {
                    ...
                    !isNaN(n)) {
                        n = Math.max(n, 0),
                        n = Math.min(n, 1),
                        this.bar.set("volume", n, "width");
                        var a = "".concat((100 * n).toFixed(0), "%");
                        this.template.volumeBarWrapWrap.dataset.balloon = a,
                        e || this.user.set("volume", n),
                        t || this.notice("".concat(this.tran("volume"), " ").concat((100 * n).toFixed(0), "%"), void 0, void 0, "volume"),
                        this.video.volume = n,
                ...
                value: function(n, e) {
                    this.pause(),
                    this.video.poster = n.pic ? n.pic : "",
                    this.video.src = n.url,
                    this.initMSE(this.video, n.type || "auto"),
                    e && (this.template.danmakuLoading.style.display = "block",
                ...
                value: function(n, e) {
                    var t = this;
                    if (this.type = e,
                    this.options.video.customType && this.options.video.customType[e])
                        "[object Function]" === Object.prototype.toString.call(this.options.video.customType[e]) ? this.options.video.customType[e](this.video, this) : console.error("Illegal customType: ".concat(e));
                    else
                        switch ("auto" === this.type && (/m3u8(#|\?|$)/i.exec(n.src) ? this.type = "hls" : /.flv(#|\?|$)/i.exec(n.src) ? this.type = "flv" : /.mpd(#|\?|$)/i.exec(n.src) ? this.type = "dash" : this.type = "normal"),
                        "hls" === this.type && (n.canPlayType("application/x-mpegURL") || n.canPlayType("application/vnd.apple.mpegURL")) && (this.type = "normal"),
                        this.type) {
                        case "hls":
                            if (window.Hls)
                        ...
                        case "flv":
                            if (window.flvjs)
                                if (window.flvjs.isSupported()) {
                                    ...
                                    r.attachMediaElement(n),
                                    r.load(),
                                    this.events.on("destroy", (function() {
                                        r.unload(),
                                        r.detachMediaElement(),
                                        r.destroy(),
                                        delete t.plugins.flvjs
                                    }
                                    ))
                                } else
                ...
                value: function(n, e) {
                    ...
                    this.on("ended", (function() {
                        t.bar.set("played", 1, "width"),
                        t.setting.loop ? (t.seek(0),
                        t.play()) : t.pause(),
                    ...
                    this.options.subtitle && (this.subtitle = new Qt(this.template.subtitle,this.video,this.options.subtitle,this.events),
                    Array.isArray(this.options.subtitle.url) && (this.subtitles = new Zt(this)),
                ...
                value: function(n) {
                    var e = this;
                    if (n = "string" == typeof n ? parseInt(n) : n,
                    this.qualityIndex !== n && !this.switchingQuality) {
                        this.prevIndex = this.qualityIndex,
                        this.qualityIndex = n,
                        this.switchingQuality = !0,
                        this.quality = this.options.video.quality[n],
                        ...
                        this.notice("".concat(this.tran("switching-quality").replace("%q", this.quality.name)), -1, void 0, "switch-quality"),
                        this.events.trigger("quality_start", this.quality),
                        this.on("canplay", (function() {
                            if (e.prevVideo) {
                                if (e.video.currentTime !== e.prevVideo.currentTime)
                                    return void e.seek(e.prevVideo.currentTime);
                                e.template.videoWrap.removeChild(e.prevVideo),
                                e.video.classList.add("dplayer-video-current"),
                                t || e.video.play(),
                                e.prevVideo = null,
                                e.notice("".concat(e.tran("switched-quality").replace("%q", e.quality.name)), void 0, void 0, "switch-quality"),
                                e.switchingQuality = !1,
                                e.events.trigger("quality_end")
                            }
                        }
                        )),
                        this.on("error", (function() {
                            e.video.error && e.prevVideo && (e.template.videoWrap.removeChild(e.video),
                            e.video = e.prevVideo,
                            t || e.video.play(),
                            e.qualityIndex = e.prevIndex,
                            e.quality = e.options.video.quality[e.qualityIndex],
                            e.noticeTime = setTimeout((function() {
                                e.template.notice.style.opacity = 0,
                                e.events.trigger("notice_hide")
                            }
                            ), 3e3),
                            e.prevVideo = null,
                            e.switchingQuality = !1)
                ...
                key: "notice",
                value: function(n) {
                    var e, t, a, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2e3, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : .8, i = arguments.length > 3 ? arguments[3] : void 0;
                    if (i && ((e = document.getElementById("dplayer-notice-".concat(i))) && (e.innerHTML = n),
                    this.noticeList[i] && (clearTimeout(this.noticeList[i]),
                    this.noticeList[i] = null)),
                    !e) {
                        var l = kt.NewNotice(n, r, i);
                        this.template.noticeList.appendChild(l),
                        e = l
                    }
                    this.events.trigger("notice_show", e),
                    o > 0 && (this.noticeList[i] = setTimeout((t = e,
                    a = this,
                    function() {
                        ...
                        t.classList.add("remove-notice"),
                        a.events.trigger("notice_hide"),
                        a.noticeList[i] = null
                    }
                    ), o))
                }
                ...
                key: "destroy",
                value: function() {
                    Ha.splice(Ha.indexOf(this), 1),
                    this.pause(),
                    document.removeEventListener("click", this.docClickFun, !0),
                    this.container.removeEventListener("click", this.containerClickFun, !0),
