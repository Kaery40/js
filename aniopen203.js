...
document.write('<link rel="icon" type="image/x-icon" href="https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen/favicon.ico">'),
document.write('<link rel="stylesheet" href="https://proxy.api.030101.xyz/unpkg.com/mdui@1.0.2/dist/css/mdui.min.css" />'),
document.write('<script src="https://proxy.api.030101.xyz/unpkg.com/mdui@1.0.2/dist/js/mdui.min.js"><\/script>'),
document.write('<link rel="stylesheet" href="https://proxy.api.030101.xyz/cdn.jsdelivr.net/npm/ionicons@2.0.1/css/ionicons.min.css">'),
document.write('<link rel="manifest" href="https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen@2.0.3/manifest.json">'),
document.write('<link rel="apple-touch-icon" href="https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen/pwa_icon/192x192nt.png">'),
document.write('<script src="https://proxy.api.030101.xyz/cdn.jsdelivr.net/npm/markdown-it@10.0.0/dist/markdown-it.min.js"><\/script>'),
document.write('<script src="https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen@2.0.3/DPlayer.min.js"><\/script>'),
...
document.write('<script src="https://proxy.api.030101.xyz/cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js"><\/script>');
var timeout2 = null;
function timeout() {
...
function nav(M) {
    var t = "";
    t += '<div style="max-width:150px;"><img class="mdui-typo-headline mdui-img-fluid folder" href="/"  style = "max-width: 100%;height: auto;width: auto;"src="https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen/aniopen.png"></div>';
    var e = M.trim("/").split("/");
    let n = "/";
    if (e.length > 0) {
        for (i in e) {
...
function file_video(M) {
    ...
    new DPlayer({
        ...
        video: {
            url: e,
            pic: "https://proxy.api.030101.xyz/cdn.jsdelivr.net/gh/RyanL-29/aniopen/background.png",
            type: "auto"
        },
        subtitle: {
            url: a,
